...
{	
$removeFromWishlistProductId = $_POST['Remove_from_Wishlist'];
$removeFromWishlistUserId = $_SESSION['session_id'];	
$sql ="DELETE FROM `Wishlist` WHERE ProductId =" .$removeFromWishlistProductId." and UserId =".$removeFromWishlistUserId;
$results = mysql_query( $sql, $conn );
if(! $results ) {
      die('Could not delete data: ' . mysql_error());
   }

#unset($_SESSION["wishlist_products"][$_POST['Remove_from_Wishlist']]);
...
<div class="main-container">
	<div class="container">
		...
		<!--<a href="shopping-cart.php" class="button checkout wc-forward"><button type="submit" name="Add_to_Cart_Wishlist"><h5>Add to Cart</h5></button>-->
		</a>
		</p>
		</form>
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="grid">
									<div class="ma-bestsellerproductslider-container">
										...
										mysql_select_db($dbname);
										$sql = "SELECT ProductId FROM `Wishlist` WHERE UserId =" .$_SESSION['session_id'];
										$results = mysql_query( $sql, $conn );
										if(! $results ) 
										{
      										die('Could not get data: ' . mysql_error());
   										}
										while($obj = mysql_fetch_array($results, MYSQL_ASSOC)) {
										...
										<li>
												...
												<form class="cart" action="wishlist.php" method="post">
												<a href="#" class="remove" title="Remove this item"><button type="submit" name="Remove_from_Wishlist" value="' . $productId .'"><i class="fa fa-times-circle"></i></button></a>
												</div>
													<img alt="" src="img/product/' .  $productId . '.jpg" class="primary-image">
												</a>
													<a class="product-name" href="shop.html#"><strong><h3>'.$productName.'</strong></h3></a>
													<span class="cart-price-box">
																<span class="amount"><h6>Price: $ '.$productPrice.'</h6></span>
